...
import { marketPlaceAddress, testTokenAddress, packAddress, gotchiAddress, chain as defaultChainId, testGhstAddress, RPCProvider } from "../../config/constances"
...
function Navigation() {
  ...
  useEffect(() => {
    ...
    if(true) {
      const _web3 = new Web3(web3 ? web3.provider : RPCProvider);
